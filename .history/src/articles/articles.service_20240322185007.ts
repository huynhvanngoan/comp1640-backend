...
export class ArticlesService {
  ...
  private async saveFileToStorage(storageName: string, file: any): Promise<string> {
    // Thực hiện lưu file vào storage và trả về đường dẫn hoặc tên file đã lưu
    // Bạn có thể sử dụng storageConfig để cấu hình lưu trữ

...
export class UserService {
  ...
  create(requestBody: RegisterUserDto, id) {
    const facultyId = this.facultyService.findById(id)
    const faculty: Partial<Faculty> = { id: facultyId }; // Adjust according to Faculty model
  const user = this.userRepo.create({...requestBody, faculty });

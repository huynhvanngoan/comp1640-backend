...
export class UserService {
  ...
  /* async create(requestBody: RegisterUserDto) {
    ...
    const faculty = await this.facultyService.findById(requestBody.facultyId);
  ...
  async create(requestBody: RegisterUserDto) {
    ...
    if (requestBody.facultyId) {
      faculty = await this.facultyService.findById(requestBody.facultyId);
    }
  
    const newUser = this.userRepo.create({ ...requestBody, facultys: faculty ? [faculty] : [] });
    return this.userRepo.save(newUser);
  }

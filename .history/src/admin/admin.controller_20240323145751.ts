...
export class AdminController {
  constructor(private readonly adminService: AdminService,
    ...
    privrequestBody: RegisterUserDto, id: import("d:/COMP-1640/Project/comp1640-backend/src/faculty/entity/faculty.entity").FacultythService,) { }


  @Post('create-user')
  registerUser(@Body() requestBody: RegisterUserDto, id: Faculty) {
    return this.authService.register(requestBody, id);
  }

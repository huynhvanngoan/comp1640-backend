...
export class UserService {
  constructor(@InjectRepository(User) private userRepo: Repository<User>, private facultyService: FacultyService) { }

  // CRUD
  async create(requestBody: RegisterUserDto,) {
    const user = this.userRepo.create(requestBody);

    user.facultys = [await this.facultyService.findById(requestBody.facultyId)];
